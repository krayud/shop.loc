...
<br>
    ...
    <div class="custom-footer-content">
 <br><center>
<a href="<?=Uri::base(false);?>"><img style="padding: 0px 15px 0px 0px;" onmouseover="this.src='<?=Uri::base(false);?>assets/img/public/vks.png';" onmouseout="this.src='<?=Uri::base(false);?>assets/img/public/vk.png';" src="<?=Uri::base(false);?>assets/img/public/vk.png" width="40" height="40" alt=""></a>
<a href="<?=Uri::base(false);?>"><img style="padding: 0px 15px 0px 0px;" onmouseover="this.src='<?=Uri::base(false);?>assets/img/public/oks.png';" onmouseout="this.src='<?=Uri::base(false);?>assets/img/public/ok.png';" src="<?=Uri::base(false);?>assets/img/public/ok.png" width="40" height="40" alt=""></a>
<a href="<?=Uri::base(false);?>"><img style="padding: 0px 15px 0px 0px;" onmouseover="this.src='<?=Uri::base(false);?>assets/img/public/fs.png';" onmouseout="this.src='<?=Uri::base(false);?>assets/img/public/f.png';" src="<?=Uri::base(false);?>assets/img/public/f.png" width="40" height="40" alt=""></a>
<a href="<?=Uri::base(false);?>"><img style="padding: 0px 15px 0px 0px;" onmouseover="this.src='<?=Uri::base(false);?>assets/img/public/ts.png';" onmouseout="this.src='<?=Uri::base(false);?>assets/img/public/t.png';" src="<?=Uri::base(false);?>assets/img/public/t.png" width="40" height="40" alt=""></a>
<br/><br/>
<?=$questionForm;?>
</center>
      </div>
