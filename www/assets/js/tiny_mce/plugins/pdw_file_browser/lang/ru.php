...
$lang = array(
    ...
    "The files where successfully copied!"                       => "Файлы успешно скопированы!",
	...
	"Name successfully changed!"                                 => "Имя успешно изменено!",
    ...
    "Language"                      => "Язык",
    "Theme"                         => "Тема",
    "Cookies need to be enabled to save your settings!"          => "Cookies должны быть включены для сохранения настроек!",
    "Save settings"                 => "Сохранить настройки",
    "Settings saved!"               => "Настройки сохранены!",
	
	"Absolute URL with hostname"    => "Абсолютный путь к файлу",
